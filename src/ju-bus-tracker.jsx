        ...
        for (const tripId in busLocations) {
            ...
            if (markers.current[tripId]) { // Update existing marker
                ...
                const marker = new window.google.maps.Marker({
                    ...
                    // --- NEW 3D BUS ICON ---
                    icon: {
                        path: 'M20.5,13.5c-0.2,0-0.5-0.1-0.7-0.2L16,11.5v-3c0-0.6-0.4-1-1-1H4c-0.6,0-1,0.4-1,1v10c0,0.6,0.4,1,1,1h1c0.6,0,1-0.4,1-1v-1h8v1c0,0.6,0.4,1,1,1h1c0.6,0,1-0.4,1-1v-2.7l3.8-1.9c0.4-0.2,0.7-0.6,0.7-1.1V14C21.5,13.7,21,13.5,20.5,13.5z M13,17.5H5v-7h8V17.5z M14,9.5H4.5C4.2,9.5,4,9.3,4,9s0.2-0.5,0.5-0.5h9.5c0.3,0,0.5,0.2,0.5,0.5S14.3,9.5,14,9.5z',
                        fillColor: '#FFC107',
                        fillOpacity: 1,
                        strokeWeight: 1,
                        strokeColor: '#424242',
